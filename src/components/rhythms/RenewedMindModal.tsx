...
const truthStatements: Record<string, string> = {
  failing: "Failure is part of learning, not your identity. Every stumble is a chance to rise stronger.",
  escape: "The urge to escape is a signal, not a command. True rest comes from presence, not avoidance.",
  "never-change": "Change is already happening. You're here, fighting. That's proof you're not who you were.",
  "too-far": "Grace has no limit. If you can breathe, you can begin again. God's mercy is new every morning.",
  alone: "You are not alone. Brothers walk this path with you. Reach out—connection breaks isolation.",
  custom: "I am not defined by my urges. I am a son of God, learning to live free.",
};
...
const RenewedMindModal = ({ open, onOpenChange, onComplete }: RenewedMindModalProps) => {
  ...
  const getCurrentTruth = () => {
    if (selectedThought && selectedThought !== "custom") {
      return truthStatements[selectedThought];
    }
    return truthStatements.custom;
  };
