...
const FreedomStrip = () => {
  ...
  return (
    <div className="bg-[#0A0A0A] rounded-2xl border border-[#C9A84C] p-6 shadow-[0_4px_24px_rgba(0,0,0,0.12)]">
      ...
      <div className="flex justify-center mb-6">
        <div className="text-center">
          ...
          <p className="text-lg text-white font-medium mt-4 tracking-[0.5px]">Pieces of New Evidence This Month</p>
        </div>
      </div>
    </div>
  );
