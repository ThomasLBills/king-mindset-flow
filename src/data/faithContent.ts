...
export const scriptures: Scripture[] = [
  ...
  },
  {
    ...
    reflection: "Sin doesn't own you. You're not under its power anymore. Grace has broken the dominion. Walk in that reality.",
  },
  {
    id: "scripture-8",
    reference: "Psalm 103:12",
    text: "As far as the east is from the west, so far does he remove our transgressions from us.",
    reflection: "Your sins aren't hovering over you. They've been removed—completely. God isn't keeping score. Neither should you.",
  },
  {
    id: "scripture-9",
    reference: "2 Timothy 1:7",
    text: "For God gave us a spirit not of fear, but of power and love and self-control.",
    reflection: "Fear and shame don't come from God. What He gives you is power, love, and a sound mind. Receive that today.",
  },
  {
    id: "scripture-10",
