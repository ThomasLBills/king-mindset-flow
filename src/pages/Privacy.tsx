...
const Privacy = () => (
  <AppLayout>
    <div className="px-5 py-6 max-w-2xl mx-auto prose prose-sm">
      ...
      <p>Your data is used to provide the Rise Up Kings service, track your progress, enable community features, and improve the app experience. We never sell your personal data.</p>
      ...
      <p>For privacy questions, contact us at <strong>support@riseupkings.com</strong>.</p>
    </div>
  </AppLayout>
);
