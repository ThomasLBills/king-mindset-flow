...
const Terms = () => (
  <AppLayout>
    <div className="px-5 py-6 max-w-2xl mx-auto prose prose-sm">
      ...
      <p>Liberated Kings is not a substitute for professional counseling or therapy. If you are in crisis, please contact a licensed professional or call 988 (Suicide & Crisis Lifeline).</p>
      ...
      <p>Questions? Reach us at <strong>hello@liberatedkings.com</strong>.</p>
    </div>
  </AppLayout>
);
